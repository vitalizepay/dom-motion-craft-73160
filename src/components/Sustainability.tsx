      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          <p className="text-xl md:text-2xl text-foreground leading-relaxed mb-8">
            <span className="font-bold text-accent">2D creations</span> <span className="font-bold">Sourcing</span> is committed to sustainability — maintaining a balance between progress and preserving natural resources.
          </p>
